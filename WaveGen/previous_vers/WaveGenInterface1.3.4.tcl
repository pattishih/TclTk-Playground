...
proc ::makeawg::resetPulseList {} {
	...
	variable makeawg::startt;
	variable makeawg::dur;
	variable makeawg::endt;
	variable makeawg::volt;
	variable makeawg::curr;
	variable makeawg::resis;
	variable makeawg::neg;
...
#///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	foreach value $pulses {
		...
		set maxAmplitude [expr max([join [array get makeawg::curr] ","])]
		set ampl2pxlRatio [expr "(($TempSpace::canvasHeight - 14) / ($maxAmplitude*2.000))"]; 	#scale y-preview by the max amplitude
